        ...
        <div className="flex space-x-4">
          ...
          <Dialog open={isPostFormOpen} onOpenChange={setIsPostFormOpen}>
            <DialogTrigger className="w-full">
              <Input
                placeholder={`तपाई के बेच्न लाग्दै हुनुहुन्छ?, ${user?.username}`}
                readOnly
            ...
            <DialogContent className="sm:max-w-[525px] max-h-[80vh] overflow-y-auto">
              ...
              <Textarea
                placeholder={`तपाईंले बेच्न लाग्नुभएको सामानको विवरण राख्नुहोस र फोटो वा भिडियो अपलोड गर्नुहोला ${user?.username}`}
