...
const Header = () => {
  ...
  return (
    <header className="bg-green dark:bg-[rgba(0, 165, 14, 1)] text-foreground shadow-md h-16 fixed top-0 left-0 right-0 z-50 p-2">
      <div className="mx-auto flex justify-between items-center p-2">
        ...
        <nav className="hidden md:flex justify-around w-[40%] max-w-md">
         <h1 className="text-green-900">e-Village</h1>
        </nav>
